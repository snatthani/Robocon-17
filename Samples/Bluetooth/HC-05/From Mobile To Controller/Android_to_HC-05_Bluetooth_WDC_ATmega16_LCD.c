...
//System Clock				:8MHz
//Project					:Android Mobile to HC-05 Bluetooth Module Wireless Data Communication with ATmega16 and LCD Display
...
int main(void)
{
	...
	hc_05_bluetooth_transmit_byte(0x0a);
	/*Transmits New Line to Bluetooth oModule for new line*/
	...
	while(1)
	{
		...
		/*Received data is displayed in 2nd row of LCD*/
	}
}
/*End of program*/
